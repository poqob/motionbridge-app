...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Gently move or gesture'**
  String get gentlyMove;

  /// No description provided for @autoDimSync.
  ///
  /// In en, this message translates to:
  /// **'Auto-Dim Sync'**
  String get autoDimSync;

  /// No description provided for @maxPacketRate.
  ///
  /// In en, this message translates to:
  /// **'Max Packet Rate (FPS)'**
  String get maxPacketRate;
